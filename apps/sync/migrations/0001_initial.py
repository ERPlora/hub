    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operation_type', models.CharField(choices=[('user_register', 'Register User'), ('user_remove', 'Remove User'), ('user_update', 'Update User'), ('module_install', 'Module Install'), ('module_uninstall', 'Module Uninstall'), ('sale_sync', 'Sale Sync')], max_length=50)),
