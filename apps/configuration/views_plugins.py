...
def plugins_index(request):
    ...
    if request.headers.get('HX-Request'):
        return render(request, 'system/plugins/partials/installed_content.html', context)
    return render(request, 'system/plugins/pages/installed.html', context)
...
def marketplace(request):
    ...
    # Use new SPA templates with HTMX support
    if request.headers.get('HX-Request'):
        return render(request, 'system/plugins/partials/marketplace_content.html', context)
    return render(request, 'system/plugins/pages/marketplace.html', context)
