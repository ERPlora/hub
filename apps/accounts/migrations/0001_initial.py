    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('basic', 'Basic'), ('solution', 'Solution'), ('custom', 'Custom')], default='custom', help_text='Origin: basic (always active), solution (from selected solution), custom (user-created)', max_length=20)),
            ],
            options={
                'verbose_name': 'Role',
