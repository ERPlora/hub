    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('basic', 'Basic'), ('solution', 'Solution'), ('custom', 'Custom')], default='custom', help_text='Origin: basic (always active), solution (from blueprint business type), custom (user-created)', max_length=20)),
            ],
            options={
                'verbose_name': 'Role',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('manager', 'Manager'), ('employee', 'Employee'), ('viewer', 'Viewer')], default='employee', max_length=20)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['hub_id', 'is_active'], name='accounts_lo_hub_id_8ac67d_idx'),
        ),
        migrations.AddIndex(
            model_name='localuser',
            index=models.Index(fields=['hub_id', 'role'], name='accounts_lo_hub_id_ba0ae0_idx'),
        ),
        migrations.AddConstraint(
            model_name='localuser',
            constraint=models.UniqueConstraint(condition=models.Q(('is_deleted', False)), fields=('hub_id', 'email'), name='unique_email_per_hub'),
        ),
        migrations.AddConstraint(
            model_name='localuser',
            constraint=models.UniqueConstraint(condition=models.Q(('cloud_user_id__isnull', False), ('is_deleted', False)), fields=('hub_id', 'cloud_user_id'), name='unique_cloud_user_per_hub'),
        ),
        migrations.AddConstraint(
