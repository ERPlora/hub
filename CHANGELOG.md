...
* fix: Update Dockerfile for production Cloud Hub deployment

- Replace runserver with gunicorn (production WSGI server)
- Add proper healthcheck using curl instead of inline Python
- Install gunicorn and whitenoise as dependencies
- Create non-root user for security
- Optimize layer caching by separating dependency install from code copy
- Add comprehensive comments and documentation
- Update .dockerignore to exclude dev-only files
- Configure proper environment variables for web deployment

🤖 Generated with [Claude Code](https://claude.com/claude-code)

Co-Authored-By: Claude <noreply@anthropic.com> ([`6f5e993`](https://github.com/ERPlora/hub/commit/6f5e993fba0b5104b6a0ab89ca573aae60c43dea))
...
* feat: hub deply wip ([`71261d3`](https://github.com/ERPlora/hub/commit/71261d3cacc9f1cffabf7b2dc2318bbed5465562))

* feat: plugin middleware ([`4e34ee1`](https://github.com/ERPlora/hub/commit/4e34ee1822fc4368ae4b0112f63b15770784cc6c))

* feat: plugin middleware ([`99107ca`](https://github.com/ERPlora/hub/commit/99107ca8addf4a986a882046d37dccfbcb5f4443))
